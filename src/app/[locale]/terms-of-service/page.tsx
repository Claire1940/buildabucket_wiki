...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Build-A-Bucket Wiki",
    description: "Read the Terms of Service for Build-A-Bucket Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our browser game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - Build-A-Bucket Wiki",
      description: "Terms and conditions for using Build-A-Bucket Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Build-A-Bucket Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Build-A-Bucket Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Build-A-Bucket Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Build-A-Bucket Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the browser basketball game "Build-A-Bucket". Our services include, but are not limited to:
            </p>
            <ul>
              <li>Build guides and strategy tips</li>
              <li>NBA player wheel breakdowns</li>
              <li>Attribute and rating explanations</li>
              <li>Season simulation results and analysis</li>
              <li>Sandbox mode experiments and templates</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> Build-A-Bucket Wiki is NOT affiliated with, endorsed by, or associated with
              Build-A-Player. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Build-A-Bucket Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Build-A-Player. We use such
            ...
            <ul>
              ...
              <li><strong>Game Availability:</strong> game features and updates may change without notice. We are not responsible for browser-based access or game changes.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, BUILD-A-BUCKET WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              The Website may contain links to third-party websites, including X and other social media platforms,
            ...
            <p>
              ...
              you and Build-A-Bucket Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@buildabucket.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@buildabucket.wiki</a>
            </p>
            <p>
