...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Build-A-Bucket Wiki',
    description: 'Copyright and intellectual property information for Build-A-Bucket Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Build-A-Bucket Wiki',
      description: 'Copyright and intellectual property information for Build-A-Bucket Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Build-A-Bucket Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Build-A-Bucket Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Build-A-Bucket Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Build-A-Player</strong> - Official Build-A-Bucket game site</li>
              <li><strong>Build-A-Player Developers</strong> - Creators of the Build-A-Bucket game</li>
            </ul>
            <p>
            ...
            <ul>
              <li><strong>Build-A-Player</strong> - Trademark of the game developer</li>
              <li><strong>Build-A-Bucket</strong> - Trademark of the game developers</li>
              <li><strong>Build-A-Bucket Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Build-A-Bucket Wiki.
            </p>
            ...
            <p>
              ...
              Build-A-Bucket Wiki<br />
              Email: <a href="mailto:dmca@buildabucket.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@buildabucket.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Build-A-Bucket Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Build-A-Bucket Wiki (buildabucket.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@buildabucket.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@buildabucket.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@buildabucket.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@buildabucket.wiki</a>
            </p>
            <p>
